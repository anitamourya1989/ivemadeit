               ...
               <div id="content">
                  <div id="content-left">
                     ...
                     <div id="core-values">
                        ...
                        <!-- <a href="/about_us/index.asp?pid=14" class="more"><span>Find Out More</span></a>
                           </span>
                           -->
                     </div>
                  </div>
                  <div id="content-right">
                     ...
                     <h3>Our Clients</h3>
                     <ul>
                        <li>Life Fitness (Brunswick Group), USA</li>
                        <li>RBC Insurance, Canada</li>
                        <li>St John's Ambulance, Canada</li>
                        <li>Dixie-Bloor Mentoring, Canada</li>
                        <li>Kaleidoscope Design, Canada</li>
                        <li>Profile, India</li>
                        <li>IGM Talent Management, India</li>
                        <li>Medpower Group, USA</li>
                        <li>Distribution Ivy, USA</li>
                     </ul>
                     <br /><br />
                     </p>
                  </div>
