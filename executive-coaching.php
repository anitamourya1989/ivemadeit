...
<head>
	<title>'I've Made It' | Executive Coaching</title>
	...
	<div id="container">
		...
		<div id="container-center">
			...
			<div id="wrapper">
				...
				<div id="advert">
					<div id="adv-left">
						<h3 class="high1">Executive Coaching</h3>
						<h5 class="high1">Focused Essence</h5>
					</div>
					<div id="adv-right" style="background-color: #fff;background-image: none;">
						<img src="images/bannerTop/ExecutiveCoaching.jpg">
					</div>
				</div>
