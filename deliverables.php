      ...
      <div id="container">
         ...
         <div id="container-center">
            <div id="header">
               ...
               <ul id="headerlinks">
                  <li><a href="individual.html" id="sitemap">coaching</a></li>
               </ul>
               <ul id="headerlinksa">
                  <li><a href="corporate.html" id="accessibility">corporate</a></li>
               </ul>
            </div>
            <div id="wrapper">
               ...
               <div id="advert">
                  <div id="advert-left3"></div>
                  <a href="resources.html" style="cursor:pointer">
                     <div id="advert-right"></div>
                  </a>
               </div>
               ...
               <div id="content">
                  <div id="content-left">
                     ...
                     <div id="core-values">
                        <h3>About Us</h3>
                        <ul>
                           <li><a href="about.html">Anita Sachdev</a></li>
                           <li><a href="deliverables.html">Our Deliverables</a></li>
                  ...
                  <div id="content-right">
                     ...
                     Our training devlops beilef, thinking styles and behaviors which formulate into a very positive habit to:
                     <ul>
                        <li>Influence people</li>
                        <li>Engage people</li>
                        <li>Enable people</li>
                        <li>Demonstrate a benefit of change</li>
                        <li>Mobilize change so “you” can personalize your success… as successful organizations depend on effective individuals. </li>
                     </ul>
                     </br>
                     <br /><br />
