...
<html>
<head>
	<title>'I've Made It' | Our Resources</title>
	...
	<div id="container">
		...
		<div id="container-center">
			...
			<div id="wrapper">
				...
				<div id="content">
					<h3 class="breadcrumb">Home > Resources</h3>
					<div id="content-left">
						<div id="core-values">
							<!-- <h3>Our services</h3> -->
							<ul>
								<li><a href="#case" class="left-link">Case for Cross Cultural Sensitivity Programs and Intercultural Management</a></li>
								<li><a href="#ec" class="left-link">Executive Coaching</a></li>
								<li><a href="#st" class="left-link">Strategic Career</a></li>
								<li><a href="#life" class="left-link">Life Coaching</a></li>
							</ul>
						</div>
					</div>
		...
		<div id="container-right">
			...
			<!-- <a href="news.html" id="morenews"><span>More News</span></a> -->
