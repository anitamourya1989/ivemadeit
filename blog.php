	...
	<div id="container">
		...
		<div id="container-center">
			...
			<div id="wrapper">
				...
				<div id="advert">
					<div id="adv-left">
						<h3 class="high1" style="padding: 13px 10px 23px 0;">Blog</h3>
						<!-- <h5 class="high1">Experts Speak</h5> -->
					</div>
				...
				<div id="content">
					<h3 class="breadcrumb">Home > Blog </h3>
					<div id="content-left">
						<div id="core-values">
						</div>
					</div>
					<div id="content-right">
						<h3>Watch out for this space</h3>
						<br>
						<br>
						<br>
						<br>
