...
<body class="home">
   <div id="container">
      ...
      <div id="wrapper">
         ...
         <div id="advert">
            <div id="adv-left">
               <h3 class="high1">Our Expertise</h3>
               <h5 class="high1">Your Voice of Clarity</h5>
            </div>
         ...
         <div id="content">
            <h3 class="breadcrumb">Home > Our Expertise</h3>
            <div id="content-left">
               <!--//Core values-->
               <div id="core-values">
                  <!-- <h3>Our Expertise</h3> -->
                  <ul>
                     ...
                     <li><a href="expertise.html#phi" class="left-link">Anita’s philosophy</a></li>
                     <li><a href="expertise.html#app" class="left-link">Approach - Facilitation and Coach Approach</a></li>
                  </ul>
               </div>
               <div class="left-border">
                  ...
                  <ol>
                     ...
                     <li>3 years Multicultural Marketing Company in New York</li>
                     <li>15 years Entrepreneurial ventures including 10 years in Learning &amp; Development in Canada/Mumbai.&nbsp;</li>
                     <li>25 years worked and lived in the USA, Canada, Egypt, Middle East</li>
                  </ol>
               </div>
               <div class="left-border">
                  <h3>Key Clients &amp; Industries</h3>
                  <ol>
                     <li>Consumer Products &ndash; Unilever, Danone, L&rsquo;oreal, Whirlpool</li>
                     <li>Pharma &ndash; GSK, Merck, Nutricia</li>
                     <li>Financial Service &nbsp;&ndash; Metlife, JP Morgan, Standard Chartered, Rabo Bank, ING Direct, Standard Chartered Bank</li>
                     <li>Consulting &ndash; Danone, Unilever(long term engagement), Life Fitness ( USA)</li>
                     <li>IT &ndash; Blue Ocean, Cummins, Praxair&nbsp;</li>
                     <li>Service Industry &ndash; Ace Technologies, Digital Productions, WNS, Lanxess</li>
                  </ol>
               </div>
               ...
               <div class="left-border">
                  ...
                  <ol>
                     <li>Adult Training and Education &ndash; University of Toronto</li>
                     <li>Coach U Certified Coach &ndash; Canada&nbsp;</li>
                     <li>ACP &ndash; IIC ( Certified Coach)</li>
                     <li>Continuing Education International Coach Academy</li>
                     <li>Advanced facilitation skills &ndash; YWCA Canada</li>
                     <li>Certified DiSC Assessment&nbsp;</li>
                     <li>Counselling Program &ndash; New York Univ</li>
                     <li>Masters in Management Program, Marketing, Advertising, Public Relation</li>
            ...
            <div id="content-right">
               ...
               <div class="clearfix"></div>
               <p>
                  Essence Coaching focus is - Be your own Guru. Become a Transformational Leader. Find your Dynamic Equilibrium.
                  Anita’s approach has a solid focus on Coaching leaders and teams to reinvent and adapt their operational styles in VUCA world along with the shifts in attitude, approach and behavior to be a leader and/or a team player in a new role or international assignment. As a coach, operates from 4 key mindset: Listening deeply, authentic speaking, questioning from a place of wonder, spacious silence.   
                  Actively coaches women to be successful leaders and crusades with organization on the need to build “Women Leaders” as well as formalized Diversity and Inclusion practices. 
                  She is on the leadership coaching team Executive for Asia: <a href="http://www.executivedevelopment.com/OurTeam/AsiaPacificAPACTeam/tabid/163/Default.aspx">Click here to know more</a></p>
                  ...
                  <div class="dlpdf">
                     ...
                     target="_blank">
                        Interview with Anita – Canadian paper
                     </a>
                  </div>
               </div>
            </div>
