...
<html>
<head>
	<title>'I've Made It' | Intercultural Coaching</title>
	...
	<div id="container">
		...
		<div id="container-center">
			...
			<div id="wrapper">
				...
				<div id="advert">
					<div id="adv-left">
						<h3 class="high1">Intercultural Coaching</h3>
						<h5 class="high1">Building Resonance</h5>
					</div>
					<div id="adv-right" style="background-color: #fff;background-image: none;">
						<img src="images/bannerTop/InterculturalCoaching.jpg">
					</div>
				</div>
